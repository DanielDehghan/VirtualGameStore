    ...
    public partial class Initials : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Apt 101", "Toronto", "Canada", new DateTime(1990, 5, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), "Leave at front door", "john.doe@example.com", "John", "Male", "Doe", "password123", "123-456-7890", "M5A 1A1", "Action", "English", "PC", "ON", true, new DateTime(2024, 11, 11, 18, 4, 26, 947, DateTimeKind.Local).AddTicks(6461), "123 Main St" },
                    { 2, "Apt 202", "Montreal", "Canada", new DateTime(1992, 8, 22, 0, 0, 0, 0, DateTimeKind.Unspecified), "Call upon arrival", "jane.smith@example.com", "Jane", "Female", "Smith", "password456", "987-654-3210", "H2X 1A1", "RPG", "French", "PlayStation", "QC", false, new DateTime(2024, 11, 11, 18, 4, 26, 947, DateTimeKind.Local).AddTicks(6507), "456 Elm St" },
                    { 3, "Suite 300", "Vancouver", "Canada", new DateTime(1995, 11, 5, 0, 0, 0, 0, DateTimeKind.Unspecified), "Leave with concierge", "alex.johnson@example.com", "Alex", "Non-binary", "Johnson", "password789", "321-654-9870", "V5K 1A1", "Shooter", "English", "Xbox", "BC", true, new DateTime(2024, 11, 11, 18, 4, 26, 947, DateTimeKind.Local).AddTicks(6512), "789 Maple Ave" },
                    { 4, null, "Calgary", "Canada", new DateTime(1995, 11, 5, 0, 0, 0, 0, DateTimeKind.Unspecified), null, "david.lee@example.com", "David", "Male", "Lee", "Dav!d1234", "403-555-0100", "T2P 1J9", "Action", "Chinese", "PC", "AB", false, new DateTime(2023, 11, 11, 18, 4, 26, 947, DateTimeKind.Local).AddTicks(6516), "101 Cedar Blvd" },
                    { 5, "5C", "Edmonton", "Canada", new DateTime(2000, 7, 22, 0, 0, 0, 0, DateTimeKind.Unspecified), "Leave with concierge", "evelyn.brown@example.com", "Evelyn", "Female", "Brown", "P@ssw0rd!", "780-555-0112", "T5J 1G9", "Strategy", "German", "Xbox", "AB", true, new DateTime(2024, 10, 27, 18, 4, 26, 947, DateTimeKind.Local).AddTicks(6522), "303 Birch Lane" },
                    { 6, null, "Ottawa", "Canada", new DateTime(1988, 9, 9, 0, 0, 0, 0, DateTimeKind.Unspecified), null, "frank.nguyen@example.com", "Frank", "Male", "Nguyen", "Fr@nk4321", "613-555-0185", "K1P 1A5", "Action", "Danish", "PC", "ON", false, new DateTime(2024, 2, 11, 18, 4, 26, 947, DateTimeKind.Local).AddTicks(6528), "567 Elm St" },
                    { 7, null, "Hamilton", "Canada", new DateTime(1993, 1, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), "Hand to resident", "gina.walker@example.com", "Gina", "Female", "Walker", "Gin@123!", "905-555-0133", "L8P 3B5", "RPG", "Italian", "Playstation", "ON", true, new DateTime(2024, 7, 11, 18, 4, 26, 947, DateTimeKind.Local).AddTicks(6536), "234 Spruce Ave" },
                    { 8, "7F", "Windsor", "Canada", new DateTime(1975, 12, 28, 0, 0, 0, 0, DateTimeKind.Unspecified), null, "henry.perez@example.com", "Henry", "Male", "Perez", "HenrY!678", "519-555-0154", "N9A 6Z8", "Horror", "Spanish", "PC", "ON", false, new DateTime(2022, 11, 11, 18, 4, 26, 947, DateTimeKind.Local).AddTicks(6541), "128 Cypress Ct" },
                    { 9, null, "Toronto", "Canada", new DateTime(1996, 4, 25, 0, 0, 0, 0, DateTimeKind.Unspecified), null, "ivy.robinson@example.com", "Ivy", "Female", "Robinson", "IvY2024!", "416-555-0213", "M5G 2M1", "Sports", "English", "Xbox", "ON", true, new DateTime(2024, 6, 11, 18, 4, 26, 947, DateTimeKind.Local).AddTicks(6545), "104 Willow Dr" },
                    { 10, "2A", "Montreal", "Canada", new DateTime(1993, 6, 12, 0, 0, 0, 0, DateTimeKind.Unspecified), "Leave in mailbox", "jack.martinez@example.com", "Jack", "Male", "Martinez", "J@ckMart123", "514-555-0183", "H3B 4P2", "Horror", "French", "PlayStation", "QC", false, new DateTime(2024, 9, 11, 18, 4, 26, 947, DateTimeKind.Local).AddTicks(6550), "789 Walnut St" },
                    { 11, null, "Calgary", "Canada", new DateTime(1998, 7, 5, 0, 0, 0, 0, DateTimeKind.Unspecified), "Deliver to back door", "karen.taylor@example.com", "Karen", "Female", "Taylor", "K@r3nT@yl0r", "403-555-0157", "T2P 2R8", "Adventure", "English", "Switch", "AB", true, new DateTime(2024, 1, 11, 18, 4, 26, 947, DateTimeKind.Local).AddTicks(6554), "562 Maple Grove" },
                    { 12, null, "Ottawa", "Canada", new DateTime(1989, 12, 14, 0, 0, 0, 0, DateTimeKind.Unspecified), null, "leo.gonzales@example.com", "Leo", "Male", "Gonzales", "Le0G0nz@!", "613-555-0114", "K2P 1X4", "Strategy", "Spanish", "PC", "ON", false, new DateTime(2024, 4, 11, 18, 4, 26, 947, DateTimeKind.Local).AddTicks(6558), "90 Forest Hill" },
                    { 13, "4D", "Vancouver", "Canada", new DateTime(1992, 10, 30, 0, 0, 0, 0, DateTimeKind.Unspecified), null, "mia.liu@example.com", "Mia", "Female", "Liu", "Mi@LiuPass1", "604-555-0179", "V6B 1N9", "Sports", "Chinese", "PlayStation", "BC", true, new DateTime(2024, 10, 17, 18, 4, 26, 947, DateTimeKind.Local).AddTicks(6562), "456 King St" }
                });
